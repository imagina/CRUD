...
use Modules\Bcrud\Exception\AccessDeniedException;
...
trait Access
{
    ...
    */
     ...
     * @return bool
     *
     * @throws \Modules\Bcrud\Exception\AccessDeniedException in case the permission is not enabled
     */
    public function hasAccessOrFail($permission)
    {
        if (! in_array($permission, $this->access)) {
            throw new AccessDeniedException(trans('bcrud::crud.unauthorized_access'));
        }

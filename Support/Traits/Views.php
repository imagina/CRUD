...
trait Views
{
    protected $createView = 'bcrud::create';
    protected $editView = 'bcrud::edit';
    protected $showView = 'bcrud::show';
    protected $detailsRowView = 'bcrud::details_row';
    protected $revisionsView = 'bcrud::revisions';
    protected $revisionsTimelineView = 'bcrud::inc.revision_timeline';
    protected $reorderView = 'bcrud::reorder';
    protected $listView = 'bcrud::list';

...
@section('header')
    <section class="content-header">
        <h1>
            ...
            <small>{{ trans('bcrud::crud.all') }} <span
                        class="text-lowercase">{{ $crud->entity_name_plural }}</span> {{ trans('bcrud::crud.in_the_database') }}
                .
            </small>
        </h1>
        <ol class="breadcrumb">
        ...
        <div class="col-md-8 col-md-offset-2">
            @if ($crud->hasAccess('list'))
                <a href="{{ url($crud->route) }}"><i
                            class="fa fa-angle-double-left"></i> {{ trans('bcrud::crud.back_to_all') }}
...
@section('after_styles')
    <link rel="stylesheet" href="{{ asset('modules/bcrud/vendor/nestedSortable/nestedSortable.css') }}">
    <link rel="stylesheet" href="{{ asset('modules/bcrud/vendor/crud/css/crud.css') }}">
    <link rel="stylesheet" href="{{ asset('modules/bcrud/vendor/crud/css/reorder.css') }}">
@endsection

@section('scripts')
    <script src="{{ asset('modules/bcrud/vendor/crud/js/crud.js') }}"></script>
    <script src="{{ asset('modules/bcrud/vendor/crud/js/reorder.js') }}"></script>
    <script src="https://code.jquery.com/ui/1.11.3/jquery-ui.min.js" type="text/javascript"></script>
    <script src="{{ url('modules/bcrud/vendor/nestedSortable/jquery.mjs.nestedSortable2.js') }}"

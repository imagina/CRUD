...
<div @include('bcrud::inc.field_wrapper_attributes') >
    ...
    <select
        ...
        @include('bcrud::inc.field_attributes', ['default_class' =>  'form-control'])
        >
...
@if ($crud->checkIfFieldIsFirstOfItsType($field, $fields))
    ...
    <!-- include select2 css-->
    <link href="{{ asset('modules/bcrud/vendor/select2/select2.min.css') }}" rel="stylesheet" type="text/css" />
    <link href="https://cdnjs.cloudflare.com/ajax/libs/select2-bootstrap-theme/0.1.0-beta.10/select2-bootstrap.min.css" rel="stylesheet" type="text/css" />
    {{-- allow clear --}}
    @if ($entity_model::isColumnNullable($field['name']))
    <style type="text/css">
        .select2-selection__clear::after {
            content: ' {{ trans('bcrud::crud.clear') }}';
        }
    </style>
    @endif
    @endpush

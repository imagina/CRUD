...
<?php
    $field['options'] = ['page_link' => trans('bcrud::crud.page_link'), 'internal_link' => trans('bcrud::crud.internal_link'), 'external_link' => trans('bcrud::crud.external_link')];
        ...
        <!-- external link input -->
          ...
          <div class="page_or_link_value <?php if (!isset($entry) || $entry->type != 'internal_link') { echo 'hidden'; } ?>" id="page_or_link_internal_link">
            <input
                ...
                class="form-control"
                name="link"
                placeholder="{{ trans('bcrud::crud.internal_link_placeholder', ['url', url(config('backpack.base.route_prefix').'/page')]) }}"

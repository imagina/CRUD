...
trait Revisions
{
    ...
    public function listRevisions($id)
    {
        ...
        $this->data['title'] = ucfirst($this->crud->entity_name).' '.trans('bcrud::crud.revisions');
        $this->data['id'] = $id;
        $this->data['revisions'] = $this->crud->listRevisions($id);

        // load the view from /resources/views/vendor/backpack/crud/ if it exists, otherwise load the one in the package
        return view('bcrud::revisions', $this->data);
    }
    ...
    public function restoreRevision($id)
    {
        ...
        if (! $revisionId) {
            ...
            return view('bcrud::inc.revision_timeline', $this->data);
        }
    }
}
